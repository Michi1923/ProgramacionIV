            ...
            <div class="card text-white" id="carCategoria">
                ...
                <div class="card-body text-dark">
                    <form method="post" @submit.prevent="guardarCategoria" @reset="nuevoCategoria">
                        <div class="row p-1">
                            <div class="col col-md-2">idLectura:</div>
                            <div class="col col-md-2">
                                <input title="Ingrese el idLectura" v-model="categoria.idLectura" pattern="[0-9]{3,10}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
                            <div class="col col-md-2">idCliente:</div>
                            <div class="col col-md-3">
                                <input title="Ingrese el idCliente" v-model="categoria.idCliente" pattern="[A-Za-zñÑáéíóúü ]{3,75}" required type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row p-1">
